...
module.exports.create = function create(code, name, credit) {
    return query('CALL create_module($1, $2, $3)', [code, name, credit]).then(function (result){
...
module.exports.deleteByCode = function deleteByCode(code) {
    ...
    return query('CALL delete_module($1)' , [code]).then(function (result) {
...
module.exports.updateByCode = function updateByCode(code, credit) {
    ...
    return query('CALL update_module($1, $2)' ,[code, credit]).then(function (result) {
